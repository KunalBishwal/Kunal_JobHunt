...
@pytest.mark.parametrize("title", [
    ...
    "Quantitative Researcher",                # quant excluded
    "Quant Trader",                           # quant excluded
    "Data Scientist, Growth",                 # data science excluded
    "Hardware Engineer, ASIC",                # hardware excluded
])
